(function ($) {
    ...
    document.getElementById("temperature").innerHTML = json_obj.temperature.toFixed(2)
    document.getElementById("water_temperature").innerHTML = json_obj.water_temperature.toFixed(2)
